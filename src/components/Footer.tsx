...
const Footer = () => {
  return (
    <footer className="bg-[#4A5759] text-white py-16">
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          {/* Logo & Tagline */}
          <div>
            <Image
              src="/images/gnp_white.png"
              alt="Good & Plenty Wellness"
              width={120}
              height={60}
              className="mb-4"
            />
            <p className="text-white/70 text-sm">
              Your journey to balance, resilience, and joy.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <Link href="/walk-and-talk" className="text-white/70 hover:text-white transition-colors text-sm">
                Walk & Talk
              </Link>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-white/70">
              <p>Houston, Texas</p>
              <p>info@goodandplentywellness.com</p>
            </div>
        ...
        <div className="border-t border-white/20 pt-8 text-center">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} Good & Plenty Wellness. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
